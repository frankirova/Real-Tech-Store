        ...
        <div className='d-flex flex-column align-items-center justify-content-center mx-auto vh-100'>
            ...
            <h2 className="fs-2 my-4">Sign up</h2>
                <form className="w-50 my-5" onSubmit={handleSubmit}>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" className="d-flex mx-2 text-secondary">Email address</label>
                        <input type="email"
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" className="d-flex mx-2 text-secondary">Password</label>
                        <input type="password"
                            className="form-control"
                    ...
                    <Link to='/Login' className='btn text-success w-50 m-2'>Log in</Link>
